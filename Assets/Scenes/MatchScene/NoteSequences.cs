...
public class NoteSequences
{
    ...
    {
        new NoteSequence(SequenceDifficulty.Easy, "Easy1", new Note[] {
            ...
            new Note(NoteDuration.Quarter, false, true, false, false),
            new Note(NoteDuration.Quarter, false, false, true, false),
            new Note(NoteDuration.Quarter, false, true, false, false),

            new Note(NoteDuration.Half, true, false, false, true),
            new Note(NoteDuration.Half, true, false, false, true),
            ...
            new Note(NoteDuration.Half, true, false, false, true),
            new Note(NoteDuration.Half, true, false, false, true),
            new Note(NoteDuration.Half, false, true, true, false),
            new Note(NoteDuration.Half, false, true, true, false),
        })
    };
